...
from rl4co.models.zoo.l2d.decoder import L2DDecoder, TensorDict
...
def train_model():
    ...
    parameters = benchmark_utils.get_rl4co_parameters_from_brandimarte_instance(filepath_benchmark_instance)
    print(parameters)
...
# train_model()
use_trained_model_on_benchmark_instance("mk02")