...
def mk09():
    _, model_path_adj, train_dataset_path, test_dataset_path, filepath_brandimarte_instance, valid_h, valid_w, w, h, _ = benchmark_values.get_benchmark_values("mk09")
    ...
    graph_name = f"mk09"
    full_path = '/cluster/datastore/vemundvb/diffusion/diff_project/mindre_prosjekt'
    graph_save_folder = f"{full_path}/results/mk09" 
    model_path_enc = f'{full_path}/models/mk09/mk09.pth'
...
def mk08():
    _, model_path_adj, train_dataset_path, test_dataset_path, filepath_brandimarte_instance, valid_h, valid_w, w, h, _ = benchmark_values.get_benchmark_values("mk08")
    ...
    graph_name = f"mk08"
    full_path = '/cluster/datastore/vemundvb/diffusion/diff_project/mindre_prosjekt'
    graph_save_folder = f"{full_path}/results/mk08" 
    model_path_enc = f'{full_path}/models/mk08/mk08.pth'
...
# generator_params, embed_size,h, w, testing_epochs, run_epochs, graph_name, graph_save_folder, train_dataset_path, test_dataset_path, model_path_enc, model_path_adj, valid_h, valid_w = mk08()
generator_params, embed_size,h, w, testing_epochs, run_epochs, graph_name, graph_save_folder, train_dataset_path, test_dataset_path, model_path_enc, model_path_adj, valid_h, valid_w = mk09()
